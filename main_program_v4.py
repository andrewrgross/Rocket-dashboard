...
#               time.sleep(0.1)
				...
				### Draw dashboard
                                ...
                                print('Set screen state to "3"')
                                screenstate = 3
                        elif screenstate == 2:		# If on the dashboard, go back to the control menu
                                screen.blit(menucontrol, (0,0))
                                screenstate = 0
     ...
     #                           subprocess.run(['vlc',video_list[0],'--play-and-exit'])
                                os.system('python3 /home/pi/Rocket-dashboard/start-main-program.py ' + str(durationInSeconds))
                                os.system('vlc ' + video_list[0] + ' --play-and-exit')
                                pygame.quit()
                                quit()
